...
model = load_model('Trained/inputs_'+str(M)+'_del_5_snr_'+str(SNR)+'.h5')
...
sigtoplot.set_axis(np.linspace(0.0, 9.9, num=100, endpoint=True), inplace=True)
sigtoplot = sigtoplot.interpolate(method='cubic')
sigtoplot.plot(marker='x')
